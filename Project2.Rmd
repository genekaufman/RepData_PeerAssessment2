---
title: "National Weather Service storm data analysis of Human Health and Economic Impact"
author: "Gene Kaufman"
...
```{r data.munge.event.type,cache=TRUE}
...
```{r data.munge.damage.fields,cache=TRUE}
